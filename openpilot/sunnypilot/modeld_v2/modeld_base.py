...
# Speed-scheduled lateral action smoothing: high-bandwidth angle-control plants sustain a
# model-in-the-loop limit cycle (~2.5 Hz) at crawl speeds where the steering authority is
# largest. Low-pass the action where the loop gain is highest; the smoothing constant is added
