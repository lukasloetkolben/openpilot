...
Ported for tesla2026 from sunnypilot (see vision_controller.py header for the
commits this incorporates). VisionState now comes from vision_controller
itself rather than cereal.custom, since tesla2026 doesn't carry sunnypilot's
custom.capnp schema.
"""
...
from openpilot.sunnypilot.selfdrive.controls.lib.smart_cruise_control.vision_controller import (
  SmartCruiseControlVision, VisionState, _ENTERING_PRED_LAT_ACC_TH,
)
