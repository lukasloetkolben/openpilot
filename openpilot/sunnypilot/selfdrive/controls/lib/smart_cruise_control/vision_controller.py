...
Ported for tesla2026 from sunnypilot, including:
  - https://github.com/dzid26/sunnypilot/commit/f57f9487690e39d7ca5c2986f71a291a55a091bf
    "SCC-V: use desired_lat_acc in turning control"
  - https://github.com/dzid26/sunnypilot/commit/f9107541448125dc0f42d7f3b979c3b1fc5aa1da
    "SCC-V: strong breaking around to lateral ISO limit"

Unlike upstream sunnypilot, VisionState is a plain enum here instead of a
cereal/capnp type, since tesla2026 doesn't carry sunnypilot's custom.capnp
LongitudinalPlanSP schema. This is state used only internally by this
controller and doesn't change any of the control logic below.
"""
...
_TURNING_ACC_V = [ACCEL_MAX, 0.5, 0., -0.4, 1.5, ACCEL_MIN]  # acc value
_TURNING_ACC_BP = [0, 1.5, 2.0, 2.8, MAX_LATERAL_ACCEL_NO_ROLL, 3.6]  # absolute value of current lat acc
